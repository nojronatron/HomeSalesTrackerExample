...
namespace HomeSalesTrackerApp.Helpers
{
    class PeopleSearchTool
    {
        ...
        public static string GetPersonDetails(PersonModel foundPerson)
        {
            try
            {
                Person foundPersonFull = ((App)Application.Current)._peopleCollection.Get(foundPerson.PersonID);
                ...
                if (foundPerson.PersonType == new BuyerModel().PersonType)
                {
                    ...
                    if (buyerPerson == null)
                    {
                        return "Buyer has not purchased any homes.";
                    }
                ...
                if (foundPerson.PersonType == new AgentModel().PersonType)
                {
                    ...
                    if (agentPerson == null)
                    {
                        return "Agent is not associated with Homes on Market or Sold.";
                    }
            ...
            {
                var GetPersonDetailsException = new Exception("Get Person Details threw an exception.", ex);
                throw GetPersonDetailsException;
            }
        }
    }
}
